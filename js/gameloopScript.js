...
function draw() {
    ...
    for (i = 0; i < gameobjects.length; i++) {
     //   if (gameobjects[i].health > 0) {
            ...
            // Draw sprite frame
            context.drawImage(image,(image.width / 6) * currentFrame ,0 ,100 ,150 ,gameobjects[0].x, gameobjects[0].y ,100 ,150);
            context.drawImage(image2,(image2.width / 6) * currentFrame, 0, 100,150, 900,0, 100, 150);
            animate(); 
    //    }
    }
}
